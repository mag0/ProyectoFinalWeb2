...
/**
 * A Mustache Template loader for inline template.
 *
 * With the InlineLoader, template can be defined at the end of any PHP source
 * file:
 *
...
class Mustache_Loader_InlineLoader implements Mustache_Loader
{
    ...
    /**
     * The InlineLoader requires a filename and offset to process template.
     *
     ...
     * file as the inline template. If the template are located in another
     * file, it would be necessary to manually specify the filename and offset.
     *
     * @param string $fileName The file to parse for inline template
     * @param int    $offset   A string offset for the start of the template.
    ...
    /**
     * Parse and load template from the end of a source file.
     */
