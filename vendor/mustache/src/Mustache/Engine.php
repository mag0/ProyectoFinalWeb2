...
class Mustache_Engine
{
     ...
     *
     *     $options = array(
     *         // The class prefix for compiled template. Defaults to '__Mustache_'.
     *         'template_class_prefix' => '__MyTemplates_',
     *
     *         // A Mustache cache instance or a cache directory string for compiled template.
     *         // Mustache will not cache template unless this is set.
     ...
     *
     *         // Optionally, enable caching for lambda section template. This is generally not recommended, as lambda
     *         // sections are often too dynamic to benefit from caching.
     *         'cache_lambda_templates' => true,
     *
     *         // Customize the tag delimiters used by this engine instance. Note that overriding here changes the
     *         // delimiters used to parse all template and partials loaded by this instance. To override just for a
     ...
     *
     *         // Enable pragmas across all template, regardless of the presence of pragma tags in the individual
     *         // template.
     ...
     *
     * This is a helper method used internally by Template instances for loading partial template. You can most likely
